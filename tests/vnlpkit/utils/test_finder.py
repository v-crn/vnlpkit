...
def test_find_path__cache_is_faster() -> None:
    ...
    diff_without_cache_time_and_with_cache_time_1 = (
        without_cache_time - with_cache_time_1
    )

    start_time = time.time()
    find_path(partial_path=partial_path, use_cache=True)
    with_cache_time_2 = time.time() - start_time
    diff_without_cache_time_and_with_cache_time_2 = (
        without_cache_time - with_cache_time_2
    )
    ...
    print(
        f"diff_without_cache_time_and_with_cache_time_1: {diff_without_cache_time_and_with_cache_time_1}"
    )
    print(
        f"diff_without_cache_time_and_with_cache_time_2: {diff_without_cache_time_and_with_cache_time_2}"
    )
